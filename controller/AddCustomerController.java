...
/** This class creates a form to add a new customer.
 *
...
public class AddCustomerController implements Initializable {
    ...
    /** This creates a new customer. After creating a new customer, a user is redirected back to the main form. */
    @FXML
    void onActionSaveCustomer(ActionEvent event) throws IOException, SQLException {
        try {
            ...
            if (appointmentRequirementsMet.equals(true)){
                CustomersQuery.insert(name, address, postalCode, phoneNumber, divisionId);
